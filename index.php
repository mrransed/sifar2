                    ...
                    <ul class="clearfix">
                        ...
                        <li class="icons dropdown"><a href="javascript:void(0)" data-toggle="dropdown">
                            ...
                            <div class="drop-down animated fadeIn dropdown-menu dropdown-notfication">
                                <div class="dropdown-content-heading d-flex justify-content-between">
                                    <span class="">2 Nuevas Notificaciones</span>  
                                    <a href="javascript:void()" class="d-inline-block">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="javascript:void()">
                                                ...
                                                <div class="notification-content">
                                                    <h6 class="notification-heading">notificacion 1</h6>
                                                    <span class="notification-text">medicamentos vencidos</span> 
                                                </div>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="javascript:void()">
                                                ...
                                                <div class="notification-content">
                                                    <h6 class="notification-heading">notificacion 2</h6>
                                                    <span class="notification-text">medicamentos vencidos</span> 
                                                </div>
                                            </a>
                                        </li>
                        ...
                        <li class="icons dropdown d-none d-md-flex">
                            <a href="javascript:void(0)" class="log-user"  data-toggle="dropdown">
                                <span>Spanish</span>  <i class="fa fa-angle-down f-s-14" aria-hidden="true"></i>
                            </a>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Medicamentos</span>
                        </a>
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="icon-globe-alt menu-icon"></i><span class="nav-text">usuarios</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="./index.html">Crear</a></li>
                            <li><a href="./index.html">Consultar</a></li>
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-1">
                            <div class="card-body">
                                <h3 class="card-title text-white">productos en venta</h3>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">Nuevos productos</h3>
                                <div class="d-inline-block">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">Ventas al año</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">4565</h2>
                                    <p class="text-white mb-0">Jan - March 2019</p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">Ventas al mes</h3>
                                <div class="d-inline-block">
